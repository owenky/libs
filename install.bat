...
call mvn install:install-file -Dfile=dependencies_xml -DgroupId=sialibs.com.sia  -DartifactId=common-client-dependency -Dversion=3.1.3 -Dpackaging=pom -DlocalRepositoryPath=.  -DcreateChecksum=true
