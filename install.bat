...
call mvn install:install-file -Dfile=dependencies_xml -DgroupId=sialibs.com.sia  -DartifactId=common-client-dependency -Dversion=3.1.2 -Dpackaging=pom -DlocalRepositoryPath=.  -DcreateChecksum=true
...
call mvn install:install-file -Dfile=javafx.base.jar -DgroupId=sialibs.openfx   -DartifactId=base -Dversion=17.0.12 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=javafx.controls.jar -DgroupId=sialibs.openfx   -DartifactId=controls -Dversion=17.0.12 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=javafx.fxml.jar -DgroupId=sialibs.openfx   -DartifactId=fxml -Dversion=17.0.12 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=javafx.graphics.jar -DgroupId=sialibs.openfx   -DartifactId=graphics -Dversion=17.0.12 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=javafx.media.jar -DgroupId=sialibs.openfx   -DartifactId=media -Dversion=17.0.12 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=javafx.properties -DgroupId=sialibs.openfx   -DartifactId=properties -Dversion=17.0.12 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
