...
call mvn install:install-file -Dfile=dependencies_xml -DgroupId=sialibs.com.sia  -DartifactId=common-client-dependency -Dversion=2.1.1 -Dpackaging=pom -DlocalRepositoryPath=.  -DcreateChecksum=true
